Public Class dev_movil
    Dim pregSinResp As Integer = 0
    Public totalDevMovil As Integer = 0
    Public pointsDevMovil As Integer = 0
    ...
    Public Sub puntajeDevMovil_avanza()
